...
public class SanPhamUserAdapter extends RecyclerView.Adapter<SanPhamUserAdapter.ViewHolder> implements Filterable {
    ...
    public SanPhamUserAdapter(Context context, ArrayList<SanPham> list, SanPhamDao dao) {
