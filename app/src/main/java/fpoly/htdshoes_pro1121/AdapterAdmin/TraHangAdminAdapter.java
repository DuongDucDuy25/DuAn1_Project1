...
public class TraHangAdminAdapter extends RecyclerView.Adapter<TraHangAdminAdapter.ViewHolder>{
    private Context context;
    private ArrayList<DonHang> list;
    private ArrayList<DonHang> listDonhang;
    private DonHangDao dao;
    public TraHangAdminAdapter(Context context, ArrayList<DonHang> list, DonHangDao dao) {
    ...
    @NonNull
    @Override
    public TraHangAdminAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TraHangAdminAdapter.ViewHolder holder, int position) {
        ...
        if (trangThai == 3) {
            holder.tvTrangThai.setText("Trả Hàng");
        } else {
